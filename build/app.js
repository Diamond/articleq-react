...
/***/ function(module, exports, __webpack_require__) {
	...
	var axiosConfig = function axiosConfig(token) {
	  var base = { "headers": { "Accept": "application/json", "Content-Type": "application/json" } };
	  if (token) {
	...
	var usersReducer = function usersReducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? ["Brandon"] : arguments[0];
	  var action = arguments[1];
	...
	var createMiddlewareStore = (0, _redux.applyMiddleware)(_reduxPromise2.default)(_redux.createStore);
	var store = createMiddlewareStore((0, _redux.combineReducers)({
	  token: logInReducer,
	  users: usersReducer,
	...
	// ACTION CREATORS
	var tryLogin = function tryLogin(identifier, password) {
	  var request = _axios2.default.post("http://localhost:4000/api/login", { username: identifier, password: password }, axiosConfig());
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(LoginFormContainer, null),
	        this.props.children
	      );
	    }
	  }]);
	...
	var LoginForm = function (_Component3) {
	  ...
	  _createClass(LoginForm, [{
	    key: "conditionalLoginForm",
	    value: function conditionalLoginForm(token) {
	      var _this4 = this;
	      ...
	      if (token) {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement("input", { type: "text", ref: "identifier", placeholder: "Username" }),
	          _react2.default.createElement("input", { type: "password", ref: "password", placeholder: "Password" }),
	          _react2.default.createElement(
	            "button",
	            { onClick: function onClick() {
	                return _this4.props.tryLogin(_this4.refs.identifier.value, _this4.refs.password.value);
	              } },
	            "Login"
	          )
	        );
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ tryLogin: tryLogin, logOut: logOut }, dispatch);
	};
	var LoginFormContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(LoginForm);

	var UserList = function (_Component4) {
	  _inherits(UserList, _Component4);
	...
	;
	var mapUserStateToProps = function mapUserStateToProps(state) {
	  return {
	    users: state.users
	  };
	};
	var UserListContainer = (0, _reactRedux.connect)(mapUserStateToProps)(UserList);
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      _reactRouter.Route,
	      { path: "/", component: App },
	      _react2.default.createElement(_reactRouter.Route, { path: "users", component: UserListContainer })
	    )
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RouterContext2 = __webpack_require__(247);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateHashHistory = __webpack_require__(216);
	...
	var _RouterContext = __webpack_require__(247);
